...
>  the memory in the machine can be devided into 2 places called the `stack` and the `heap`, each of them has its advantages and disadvantages. lets dive into some details.
